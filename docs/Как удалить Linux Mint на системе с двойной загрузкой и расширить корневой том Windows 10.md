...
4. Наведите курсор на блок в полосе сверху так, чтобы он изменился на перекрестные стрелки.
...
7. В списке разделов нажмите правой кнопкой мыши на **extended**. Выберите **Resize/Move**.
