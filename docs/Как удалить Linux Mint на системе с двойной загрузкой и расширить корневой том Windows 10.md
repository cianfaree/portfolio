...
В этой справочной статье описывается, как расширить корневой том Windows&nbsp;10 предварительно удалив Linux Mint с жесткого диска.
...
2. В Windows&nbsp;10 удалите разделы диска, связанные с Linux Mint.
3. В программе **diskpart** удалите данные загрузчика GRUB.
4. Загрузите Linux Mint со съемного носителя. В программе **GParted** перераспределите освободившееся место на жестком диске.
5. Загрузите Windows&nbsp;10 со съемного носителя, запустите командную строку и выполните команду `bootrec.exe /fixmbr`.
6. Загрузите Windows&nbsp;10 и расширьте корневой том в программе **Управление дисками**.
...
2. Найдите разделы Linux Mint (используйте размеры разделов, которые узнали ранее). Выберите нужный раздел, нажмите на него правой кнопкой мыши → **Удалить том…**
...
4. На месте тома появится свободный раздел.

![5](images/5.png)

5. Закройте программу **Управление дисками**.

## Шаг 3. Удалите данные загрузчика GRUB

1. Откройте меню **Пуск** и напишите _командная строка_. В столбце справа выберите **Запуск от имени администратора**.
...
> **Примечание**
>
> Вместо буквы **E** можно указать любую другую букву латинского алфавита **(кроме A и B)**, которая ещё не занята в файловой системе.
...
11. Перейдите в каталог _efi_, выполнив команду `CD efi`.
12. Выполните команду `dir`.

![12](images/12.png)

13. Появится содержимое каталога. Необходимо удалить вложенный каталог _ubuntu_. Чтобы это сделать, выполните команду `rd ubuntu /s`.
14. Появится предупреждение. Введите _Y_ и нажмите **Ввод**.

![13](images/13.png)

15. Снова выполните команду `dir`. Убедитесь, что каталога _ubuntu_ нет в списке.
16. Выполните команду `diskpart`.
17. В программе **diskpart** выполните команду `list volume`.
18. Появится список томов. Найдите тот, для которого ранее указали букву _E_ (в данном случае&nbsp;&ndash; 3).
...
## Шаг 4. Используйте загрузочный диск с Linux Mint, чтобы переместить разделы и освободить место для расширения корневого тома Windows&nbsp;10

1. Вставьте загрузочный диск с системой Linux Mint в компьютер и загрузитесь с него.
2. Откройте программу **GParted**.
3. Нажмите правой кнопкой мыши на загрузочный раздел с файловой системой _FAT32_ и выберите **Resize/Move**.

![14](images/14.png)

4. Наведите курсор на цветной блок в полосе сверху так, чтобы он изменился на перекрестные стрелки.

![15](images/15.png)

5. Перетащите раздел в противоположный конец полосы и нажмите **Resize/Move** в правом нижнем углу окна.

![16](images/16.png)

6. Появится окно с предупреждением (_Moving a partition might cause your operating system to fail to boot_). Нажмите **OK**.
7. В списке разделов нажмите правой кнопкой мыши на **extended** (расширенный). Выберите **Resize/Move**.

![17](images/17.png)

8. Наведите курсор на стрелку в начале полосы так, чтобы он изменился на значок с горизонтальными стрелками.

![18](images/18.png)

9. Сократите раздел вправо до конца полосы и нажмите **Resize/Move**.

![19](images/19.png)

10. На панели сверху нажмите на **зеленую галочку** (_Apply All Operations_).

![20](images/20.png)

11. Появится предупреждение об изменении разделов на диске (_Are you sure you want to apply the pending operations?_). Нажмите **Apply** (Применить).
12. Начнется процесс перемещения разделов на диске. Когда он завершится, над индикатором выполнения появится надпись _All operations successfully completed_.

![21](images/21.png)

13. Закройте все окна и выключите компьютер.
...
5. На этапе выбора диска выберите диск **0** и укажите в поле ввода максимально допустимый размер выделяемого пространства, указанный в поле выше.

![23](images/23.png)

6. Программа расширит корневой том. На этапе завершения работы мастера нажмите **Готово**.
