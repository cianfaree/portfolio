...
В этой справочной статье описывается, как расширить корневой том Windows&nbsp;10 путем удаления Linux Mint с жесткого диска.
...
6. Загрузите Windows&nbsp;10 и выполните расширение тома в программе **Управление дисками**.
